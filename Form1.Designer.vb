...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        cmbMode.Items.AddRange(New Object() {"1-鎖定螢幕", "2-顯示設置", "3-電腦資訊"})
        ...
        lblRAMUsage.Text = "RAM 使用量: 0.0GB / 0.0GB"
        ' 
        ' lblLEDOutput
        ' 
        ...
        Name = "Form1"
        Text = "114學年度工業類科學生技藝競賽-電腦修護 崗位號碼: XX"
        ResumeLayout(False)
        PerformLayout()
    End Sub
